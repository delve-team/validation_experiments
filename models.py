...
class SimpleCNN(nn.Module):
    def __init__(self, c_channels: int = 3, l1: int = 8, l2: int = 16, l3: int = 32, n_classes: int = 10):
        super(SimpleCNN, self).__init__()
        self.conv0 = nn.Conv2d(in_channels=c_channels, out_channels=l1, kernel_size=(3,3), stride=2)
        ...
        self.pool = nn.AdaptiveConcatPool2d()
        self.readout = nn.Flatten()
        self.out = nn.Linear(c3, n_classes)
